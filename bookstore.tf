...
resource "aws_instance" "tf-docker-ec2" {
    ...
    user_data = <<-EOF
               ...
               TOKEN="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"
               FOLDER="https://$TOKEN@raw.githubusercontent.com/alexasiz/Project-203-Dockerization/main/"
               ...
               docker build -t 404212/bookstoreapi:latest .
               docker-compose up -d
               EOF
}
